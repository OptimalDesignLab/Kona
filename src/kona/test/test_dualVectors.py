...
from vectors import DualVector
...
solver = UserObj(2, 2, 2)
# initialize Kona user memory
memory = UserMemory(solver, 1, 1, 3)
    
# unit tests begin here
class test_dualVectors(unittest.TestCase):
        
    def test_assignment(self):
        # assign design vector
        D1 = DualVector(memory)
        D2 = DualVector(memory)
        D3 = DualVector(memory)
        # check vector assignment flags
        self.assertTrue(
            all(item == True for item in memory.vecAssigned[DualVector])
            )
        del D1, D2, D3
    ...
    def test_equalScalar(self):
        ...
        D1.Equals(1.0)
        # get the vector data
        D1data = solver.kona_storage[2][D1.GetIndex()]
    ...
    def test_equalsVector(self):
        ...
        D2.Equals(D1)
        # # get the vector data
        D2data = solver.kona_storage[2][D2.GetIndex()]
        # check solver storage to confirm
        self.assertTrue(
    ...
    def test_AXPlusBY(self):
        ...
        # get the vector data
        D3data = solver.kona_storage[2][D3.GetIndex()]
        # check solver storage to confirm
        self.assertTrue(
    ...
    def test_deletion(self):
        ...
        del D3
        # check vector assignment flags
        self.assertTrue(all(item == False for item in memory.vecAssigned[DualVector]))
