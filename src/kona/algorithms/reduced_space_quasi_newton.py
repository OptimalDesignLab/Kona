...
class ReducedSpaceQuasiNewton(object):
    ...
    def solve():
        ...
        initial_design = self.state_factory.generate()
        design_work = self.state_factory.generate()
        ...
        nonlinear_sum = 0
        converged = False
        for i in arange(optns['max_iter']):
            state.equals_state_solution(x)
            ...
            if i == 0:
                ...
                self.quasi_newton.set_norm_init(grad_norm0)
