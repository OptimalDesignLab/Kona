    ...
    def solve(self):
        ...
        for i in xrange(self.max_iter):
            ...
            if self.iter == 1:
                ...
                self.grad_norm0 = dLdX._primal.norm2
                self.design_norm0 = dLdX._primal._design.norm2
                self.slack_norm0 = dLdX._primal._slack.norm2
                self.feas_norm0 = max(dLdX._dual.norm2, EPS)
